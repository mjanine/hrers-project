/**
 * head_attendance.js
 * Department Head view - attendance viewer for team members.
 * Reuses the HR multi-employee logic: select a team member and view summaries.
 * Clock actions are intentionally disabled for heads (read-only view).
 */
...
async function fetchEmployees() {
    // Load team members for this head; backend should scope by manager if necessary.
...
function populateEmployeeSelect(list) {
    ...
    const placeholder = document.createElement('option'); placeholder.textContent = 'Select a team member'; placeholder.value = ''; employeeSelect.appendChild(placeholder);
    list.forEach(emp => {
